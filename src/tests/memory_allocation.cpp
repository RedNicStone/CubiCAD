...
int main() {
    ...
    std::cout
        << "Creation of the allocator took "
    ...
    std::cout
        << "Decrasing the allocation size to x/4 took "
        << std::chrono::duration_cast<std::chrono::microseconds>(t7 - t6).count()
        << " us."
        << std::endl;

    std::cout
        << "Increasing the allocation size to x4 took "
